...
/**
 * Class Raketech_Assessment_Run
 *
 * Thats where we bring the plugin to life
 *
 * @package		RAKETECHAS
 * @subpackage	Classes/Raketech_Assessment_Run
 * @author		Joshua Maher
 * @since		1.0.0
 */
class Raketech_Assessment_Run{
	...
	/**
	 * Our Raketech_Assessment_Run constructor 
	...
	public function enqueue_backend_scripts_and_styles() {
		wp_enqueue_style( 'raketechas-backend-styles', RAKETECHAS_PLUGIN_URL . 'core/includes/assets/css/backend-styles.css', array(), RAKETECHAS_VERSION, 'all' );
		wp_enqueue_script( 'raketechas-backend-scripts', RAKETECHAS_PLUGIN_URL . 'core/includes/assets/js/backend-scripts.js', array(), RAKETECHAS_VERSION, false );
		wp_localize_script( 'raketechas-backend-scripts', 'raketechas', array(
			'plugin_name'   	=> __( RAKETECHAS_NAME, 'raketech-assessment' ),
		));
	}
	...
	public function add_wp_webhooks_integrations(){
		...
		$folder = RAKETECHAS_PLUGIN_DIR . 'core' . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'integrations';
